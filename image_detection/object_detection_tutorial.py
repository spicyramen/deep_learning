...
# Object detection imports from Tensorflow.
...
opener.retrieve('%s%s' % (DOWNLOAD_BASE, MODEL_FILE), MODEL_FILE)
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        for image_path in TEST_IMAGE_PATHS:
            ...
            # Set a minimum score threshold of 50%.
            threshold = 0.50
